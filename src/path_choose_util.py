...
def show_and_choose_folder_in_dir(searchInDir):
    ...
    while True:
        ...
        if user_input.lower() == 'q':
            ...
            git_project_folder_path = joinFullPath(searchInDir, user_input)
...
def show_and_choose_file_in_dir(searchInDir, fileExtension, GiveupChoose=False):
    ...
    lastBranchsInfo_files = [joinFullPath(searchInDir, f) for f in os.listdir(searchInDir) if f.endswith(fileExtension)]
    ...
    while True:
        ...
        if user_input.lower() == 'q':
            ...
            last_branchs_info_file_path = joinFullPath(searchInDir, user_input)
